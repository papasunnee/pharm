...
<div class="top-form top-form-minicart emarket-minicart2 pull-right">
	<div class="top-minicart-icon pull-right">
		<a class="cart-contents" href="<?php echo wc_get_cart_url(); ?>" title="<?php esc_attr_e('View your shopping cart', 'emarket'); ?>"><?php echo '<span class="minicart-number">'.$woocommerce->cart->cart_contents_count.'</span>';?>
				<span class="text-cart"><?php esc_html_e('My Bag', 'emarket'); ?></span>
		</a>
	</div>
