   ...
   function main_shortcode_output( $atts, $content = null )
    {
      ...
      { 
        ...
        //$chatflag = true ;
        //$out = "<div class='fep-error'>".sprintf(__("Please <a href=https://pharm.com.ng/my-account>login</a> to speak with us.", 'front-end-pm'), wp_login_url( get_permalink()) )."</div>";
        //$out = "<div class='fep-error'>".sprintf(__("Please <a href=https://pharm.com.ng/my-account?redirect_to=https%3A%2F%2Fpharm.com.ng%2Fchat%2F>login</a> to speak with us."), wp_login_url( https://pharm.com.ng/chat )."</div>";
        //$out = "<div class='fep-error'>".sprintf(__("Please <a href='%s'>login</a> to speak with us", 'https://pharm.com.ng/my-account?redirect_to=https%3A%2F%2Fpharm.com.ng%2Fchat%2F'), wp_login_url( get_permalink() ) )."</div>";   
        
        /*echo '<div class="fep-error">';
        echo "Please ";
        //echo "<a href=https://pharm.com.ng/my-account?redirect_to=https%3A%2F%2Fpharm.com.ng%2Fchat%2F>login</a>";
        //echo "<a href=https://pharm.com.ng/wp-login.php?redirect_to=https%3A%2F%2Fpharm.com.ng%2Fchat%2F>login</a>";
        echo sprintf(__("<a href=https://pharm.com.ng/my-account>login</a>"), wp_login_url( wc_get_page_permalink( 'chat' ) ) );
        echo " to speak with us";
        echo '</div>';*/
