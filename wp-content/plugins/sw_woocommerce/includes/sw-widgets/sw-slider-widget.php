			...
			vc_map( array(
				...
				"params" => array(
					...
					array(
						...
						'dependency' => array(
							'element' => 'layout',
							'value' => array( 'theme_mobile2','layout6'),
							)
						),
					array(
						"type" => "dropdown",
					...
					array(
						...
						"param_name" => "layout",
						"admin_label" => true,
						"value" => array( 'Layout Default' => 'default', 'Layout Most Views' => 'default1', 'Layout Mobile1' => 'theme_mobile', 'Layout Mobile2' => 'theme_mobile2' ),
