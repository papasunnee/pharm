									...
									<div class="slider responsive">
										...
										if( $i % $item_row2 == 0 ){
											...
											<div class="item product <?php echo 'item-'.esc_attr( $item_row2 ).'columns' ?> <?php echo esc_attr( $class )?>">
												...
												<?php echo ( $i % $item_row2 == $item_row2 - 1 )? '</div>' : ''; ?>
